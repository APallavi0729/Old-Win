...
<br>
<div class="space">
<div id="comp-kmiotf2s2" class="_1Z_nJ" data-testid="richTextElement"><h1 class="font_6" style="text-align:center;line-height:1.35em;font-size:30px"><span class="color_18"><span style="font-weight: bold;">About WinLinsys</span></span></h1></div>
<hr>
<div id="comp-kmiotf2s3" class="_1Z_nJ" data-testid="richTextElement"><p class="font_8" style="text-align:center;line-height:1.75em;font-size:20px"><span class="color_15">Knowledge is Power</span></p></div>
<br>
<div id="comp-kmiotf2t" class="_1Z_nJ" data-testid="richTextElement"><p class="font_9" style="line-height:1.875em;text-align:center;font-size:18px"><span class="color_15">At WinLinsys,
 we’re committed to encouraging both staff and students to continuously create, grow and learn. 
 Our curriculum reflects this commitment, as well as the diverse backgrounds and cultures of our instructors and participants alike.<br>
<br>
We offer an unmatched variety of courses and programs, 
created for individuals or groups of all ages and academic levels. 
Browse our site to learn more, and get in touch if you have any questions.</span></p></div>
<br>
<br>
<section class="Section">
    ...
    <div class="boxmain">
         ...
         <p class="text-small">WinLinsys Technologies was established in December 2002 by two ambitious IT professionals 
        Pallavi Bhardwaj;
           It is a critical situation for every IT guy who has started from desktop support Engineer to select a particular domain
            to go ahead with, the boys went for each domain and found the way to find the exact domain by checking the interest and
             understanding each of them,and this was the only reason they planned to build a path for each fresher or an experienced
              IT professional in dilemma to get his domain ,train them well and make them go ahead in his field of interest</p>
